...
//       (NSURLCache(memoryCapacity: 0, diskCapacity: 0, diskPath: nil))
    ...
    lazy var applicationDocumentsDirectory: URL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.home.musicvideo.MusicVideo" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "MusicVideo", withExtension: "momd")!
